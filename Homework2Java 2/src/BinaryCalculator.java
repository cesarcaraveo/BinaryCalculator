...
//		System.err.println("divisor: " + bits2string(divisor));
//		System.err.println("remainder: " + bits2string(remainder));
...
//			System.err.println("Remainder after subtracting: " + bits2string(remainder));
//			System.err.println("divisor: " + bits2string(divisor));

			if (remainder[0]) { // checks if less than 0
				remainder = add(remainder, divisor);
				//System.err.println("Remainder after adding: " + bits2string(remainder));

//				System.err.println("quotient before shifting: " + bits2string(quotient));
				shiftLeft(quotient);
				//System.err.println("quotient less than: " + bits2string(quotient));
			}
			
			else { // if greater than or equal to 0
//				System.err.println("quotient before shifting in else: " + bits2string(quotient));
				shiftLeft(quotient);
//				System.err.println("quotient after shifting in else: " + bits2string(quotient));
				quotient[quotient.length - 1] = true; // sets LSB (right most bit) to 1
				//System.err.println("quotient after setting lsb to 1: " + bits2string(quotient));
			}
			
			shiftRight(divisor);
		}

//		System.err.println("remainder before condensing: " + bits2string(remainder));
...
//		System.err.println("quotient before returning: " + bits2string(quotient));
		return quotient;
	}
